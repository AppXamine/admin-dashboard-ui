...
function Gallary() {
    ...
    const handlerDescriptionText = (e, id) => {
            ...
            <div className="screen">
                ...
                <div className="gallaryContainer">
                    <div className="w-full text-center ">
                        <p className="m-0 text-[#011635] tracking-[-0.025rem] text-[3em] font-bold">Gallery File Uploader</p>
                    </div>
                            ...
                            {data.map((value, index) => <div className="uploadImageUi">
                                ...
                                <div className="uploadInputs">
                                    ...
                                    <div className="galleryUploadInput">
                                        ...
                                        <Input placeholder="Enter gallery title here" maxLength={50} className="inputUploadGallery" onChange={e => handleTitleText(e, value.id)} />
                                    ...
                                    <div className="galleryUploadInput">
                                        ...
                                        <Input.TextArea
                                            onChange={e => handlerDescriptionText(e, value.id)}
                                            maxLength={360}
                                            showCount
                                            style={{
                                                height: 90,
